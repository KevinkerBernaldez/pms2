<div id="transfer-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static">
            ...
            <div class="modal-body" id="report-form">
                ...
                <div class="header">
                    ...
                    <div class="header-content">
                        ...
                        <h5>Property Management Office</h3>
                        <h5>TRANSFER OF PROPERTY & EQUIPMENT</h3>
                    </div>
                </div>
