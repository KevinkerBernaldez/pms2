<div id="slip-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static">
            ...
            <div class="modal-body" id="report-form">
                ...
                <div class="header">
                    ...
                    <div class="header-content">
                        ...
                        <p>Tel. Nos. +63 085 343-5231, 283-3113</p>
                        <br>
                ...
                <table id="request-table" width="100%">
                    <thead></thead>
                    <tbody></tbody>
                </table>
                ...
                <div>
                    <table class="form-table" style="width: 50%;">
                        <tr>
                            <th>Form Code No.</th>
                            <td class="txt-bold">: FM-DPM-SMCC-PMS-04</td>
                        </tr>
                        <tr>
                            <th>Issue Status</th>
